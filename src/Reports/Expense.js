    ...
    return (
        <div style={{ padding: "24px", background: "#f9fafc" }}>
                    ...
                    <Card style={{ background: "#f3f6fe", color: "#3b60db" }} bordered={false}>
                        <Flex justify={'space-between'}>
                            <div>
                                ...
                                <div style={{ color: "#9aa3c4" }}>Total Payment</div>
                            </div>
                            <div>
                    ...
                    <Card style={{ background: "#fff7e6", color: "#d48806" }} bordered={false}>
                        ...
                        <Flex justify={'space-between'}>
                            ...
                            <div>
                                ...
                                <div style={{ color: "#d48806" }}>Total Bill</div>
                            </div>
                            <div>
                    ...
                    <Card style={{ background: "#f6ffed", color: "#52c41a" }} bordered={false}>
                        <Flex justify={'space-between'}>
                            ...
                            <div>
                                ...
                                <div style={{ color: "#52c41a" }}>Total Expense</div>
                            </div>
                            <div>
            ...
            <Table
                ...
                pagination={false}
                bordered
                title={() => <h3>Payment - Jan - Dec 2022</h3>}
